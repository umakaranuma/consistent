...
class FoodDatabase {
  static const List<FoodItem> breakfastItems = [
    FoodItem(id: 'b1', name: 'Puttu (1 cylinder)', category: 'breakfast',
      description: 'Rice flour & coconut puttu', icon: '🍚',
      calories: 240, protein: 4, carbs: 42, fat: 8, servingSize: '1 cylinder'),
    FoodItem(id: 'b2', name: 'Thosai (2 pcs)', category: 'breakfast',
      description: 'Rice & urad dal dosa with sambar', icon: '🥞',
      calories: 260, protein: 8, carbs: 40, fat: 6, servingSize: '2 pieces'),
    FoodItem(id: 'b3', name: 'Idly (3 pcs)', category: 'breakfast',
      description: 'Steamed rice cakes with chutney', icon: '⚪',
      calories: 195, protein: 6, carbs: 36, fat: 1, servingSize: '3 pieces'),
    FoodItem(id: 'b4', name: 'String Hoppers (6 pcs)', category: 'breakfast',
      description: 'Idiyappam with curry', icon: '🍜',
      calories: 280, protein: 5, carbs: 50, fat: 4, servingSize: '6 pieces'),
    FoodItem(id: 'b5', name: 'Egg Roti (1 pc)', category: 'breakfast',
      description: 'Godamba roti with egg filling', icon: '🥚',
      calories: 350, protein: 14, carbs: 38, fat: 16, servingSize: '1 piece'),
    FoodItem(id: 'b6', name: 'Oats Porridge', category: 'breakfast',
      description: 'Oats with milk and banana', icon: '🥣',
      calories: 310, protein: 12, carbs: 48, fat: 8, servingSize: '1 bowl'),
    FoodItem(id: 'b7', name: 'Bread & Eggs', category: 'breakfast',
      description: '2 toast + 2 scrambled eggs', icon: '🍳',
      calories: 380, protein: 22, carbs: 35, fat: 14, servingSize: '2 slices + 2 eggs'),
    FoodItem(id: 'b8', name: 'Pittu & Coconut Milk', category: 'breakfast',
      description: 'Pittu with lunu miris and coconut milk', icon: '🥥',
      calories: 420, protein: 6, carbs: 52, fat: 22, servingSize: '2 cylinders'),
    FoodItem(id: 'b9', name: 'Fruit Smoothie Bowl', category: 'breakfast',
      description: 'Mixed fruits, yogurt, granola', icon: '🍓',
      calories: 280, protein: 10, carbs: 45, fat: 6, servingSize: '1 bowl'),
    FoodItem(id: 'b10', name: 'Protein Pancakes', category: 'breakfast',
      description: 'Oat pancakes with whey protein', icon: '🥞',
      calories: 340, protein: 28, carbs: 35, fat: 8, servingSize: '3 pancakes'),
  ];
